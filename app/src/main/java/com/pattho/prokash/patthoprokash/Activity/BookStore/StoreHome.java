...
public class StoreHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryListViewAdapter = new CategoryListView_Adapter(StoreHome.this, categoryGroupList, categoryListItem);
        ...
        sliderRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    sliderAdapter = new StoreSliderAdapter(StoreHome.this, sliderList);
...
//---------------------------------------------------------------------------------
        ...
        allBookRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, booksModelList);
                        ...
                        allBookRef.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (snapshot.exists()) {
                                    ...
                                    storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list1);
                    ...
                    allBookRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list2);
                    ...
                    allBookRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list3);
                    ...
                    allBookRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list4);
                    ...
                    allBookRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list5);
                    ...
                    allBookRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list6);
                    ...
                    allBookRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list7);
...
//---------------------------------------------------------------------------------
                    ...
                    allBookRef.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                storeBookListAdapter = new StoreBookListAdapter(StoreHome.this, list8);
    ...
    private void onClickData() {
        ...
        view1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), StoreViewAllBooks.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        actionView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StoreHome.this, StoreCart.class);
                startActivity(intent);
            }
        });
    ...
    private void initData() {
        ...
        getSupportActionBar().setTitle("পাঠ্য ই-স্টোর");
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.store_menu_login_0:
                        ...
                        Toast.makeText(StoreHome.this, "hola", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(StoreHome.this, SignIn.class);
                        startActivity(intent);
                        return true;

                    case R.id.store_menu_logout_1:
                        new AlertDialog.Builder(StoreHome.this,R.style.AlertDialogStyle)
                                .setTitle("Log Out!")
                                ...
                                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        Intent intent2 = new Intent(StoreHome.this, SignIn.class);
                    ...
                    case R.id.store_menu_my_order_1:
                        Intent intent5 = new Intent(StoreHome.this, StoreOrderView.class);
...
//                        finish();
                    ...
                    case R.id.store_menu_my_account_1:
                        ...
                        Intent intent4 = new Intent(StoreHome.this, UserDetails.class);
