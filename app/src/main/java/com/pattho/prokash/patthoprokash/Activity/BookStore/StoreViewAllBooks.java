...
public class StoreViewAllBooks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_store_view_all_books);
        initData();
    ...
    private void databaseFunction() {
            ...
            LinearLayoutManager layoutManager = new LinearLayoutManager(StoreViewAllBooks.this);
            GridLayoutManager gridLayoutManager = new GridLayoutManager(StoreViewAllBooks.this, 3);
                        ...
                        allBookRef.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (snapshot.exists()) {
                                    ...
                                    adapter = new StoreViewAll_Adapter(StoreViewAllBooks.this, booksModelList);
